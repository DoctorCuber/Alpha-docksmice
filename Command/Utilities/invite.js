module.exports = {
    ...
    execute(message, args, Discord){
        let inviteEmbed = new Discord.MessageEmbed()
            ...
            .setURL("https://discord.com/api/oauth2/authorize?client_id=762747906930507786&permissions=8&scope=bot")
            .setDescription("For the invite to the DocksMice Discord bot click above!!")
